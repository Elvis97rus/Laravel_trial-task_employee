                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <router-link
                                ...
                                class="float-right">Back</router-link>
                        </div>
                        ...
                        <div class="card-body">
                            <form @submit.prevent="storeEmployee">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input v-model="form.first_name"
                                            id="first_name" type="text" class="form-control" name="first_name" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select
                                            ...
                                            @change="getStates()"
                                            id="country" name="country_id" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select
                                            ...
                                            @change="getCities()"
                                                id="state" name="state_id" class="form-control" aria-label="Default select example">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select
                                            ...
                                            id="department" name="department_id" class="form-control" aria-label="Default select example">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select
                                            ...
                                            id="city" name="city_id" class="form-control" aria-label="Default select example">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input v-model="form.zip_code"
                                               id="zip_code" type="text" class="form-control" name="zip_code">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <datepicker  v-model="form.date_hired"
                                                     input-class="form-control"></datepicker>
                                    </div>
                                </div>
